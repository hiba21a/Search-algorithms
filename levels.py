...
def get_levels():
    ...
    level3_squares =[
        ...
        Square(3, 0, COLOR_BLACK),            
        Square(4, 0, COLOR_BLACK),           
        Square(5, 0, COLOR_WHITE),            
        Square(6, 0, COLOR_WHITE),            
        Square(7, 0, COLOR_WHITE),            
        Square(8, 0, COLOR_WHITE),           

        Square(1, 1, COLOR_WHITE, is_goal=True, goal_color=COLOR_GREEN),  
        Square(2, 1, COLOR_WHITE),            
        Square(3, 1, COLOR_WHITE),            
        Square(4, 1, COLOR_WHITE),           
        Square(5, 1, COLOR_BLACK),            
        Square(6, 1, COLOR_WHITE),            
        Square(7, 1, COLOR_WHITE),            
        Square(8, 1, COLOR_WHITE),            

        Square(1, 2, COLOR_WHITE),  
        Square(2, 2, COLOR_WHITE),  
        Square(3, 2, COLOR_WHITE, is_goal=True, goal_color=COLOR_RED),  # Goal for red square
        Square(4, 2, COLOR_WHITE),  
        Square(5, 2, COLOR_WHITE),  
        ...
        Square(2, 3, COLOR_WHITE),  
        Square(3, 3, COLOR_WHITE),  
        Square(4, 3, COLOR_WHITE),  
        Square(5, 3, COLOR_WHITE),  
        Square(6, 3, COLOR_RED, move=True),           
        Square(7, 3, COLOR_GREEN, move=True),          
